...
public class aesEncryptJob extends Configured implements Tool{

    public static void main(String[] args) throws Exception {

        int exitCode = ToolRunner.run(new aesEncryptJob(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "EncryptJob");
//        job.setNumReduceTasks(10); // We can also set no of reducers, with increase in no of reducers  there is less chance to get a failure in merging process.
        ...
        job.setMapperClass(aesEncryptMapper.class);
        job.setReducerClass(aesEncryptReducer.class);
